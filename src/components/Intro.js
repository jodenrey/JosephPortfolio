  ...
  render() {
    return (
      <div id="intro">
        ...
        <FadeInSection>
          <div className="intro-subtitle">I code and create stuff sometimes.</div>
          <div className="intro-desc">
            I'm a computer science student based in Philippines. I have great
            interest in full-stack development, artificial intelligence,
            human-computer interactions, and everything in between.
          </div>
          <a
            href="mailto:josephdennisreyes@gmail.com"
